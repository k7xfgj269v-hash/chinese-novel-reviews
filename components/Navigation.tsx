...
export default function Navigation() {
  ...
  return (
    <nav
      ...
      className="bg-white dark:bg-gray-900 shadow-md border-b border-gray-100 dark:border-gray-800"
    >
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative group">
              ...
              <div
                className={`absolute left-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-10 transition-all duration-200 border border-gray-200 dark:border-gray-700 ${
                  isGenreOpen
                    ? 'opacity-100 visible'
